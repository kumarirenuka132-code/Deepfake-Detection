...
st.markdown(
    '<h1 class="main-title">🛡️ Deepfake Detection using Vision Transformer (ViT)</h1>',
    unsafe_allow_html=True
)

st.markdown(
    '<p class="sub-title">Upload an Image or Video to detect whether it is Real or Fake.</p>',
    unsafe_allow_html=True
)
